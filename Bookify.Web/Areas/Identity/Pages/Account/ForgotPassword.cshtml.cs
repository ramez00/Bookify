    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    { "imageUrl","https://res.cloudinary.com/masl7a/image/upload/v1711280483/Reset-Password_nleazc.png"},
                ...
                await _emailSender.SendEmailAsync("eng.ramez.mohamed@gmail.com", "Reset your Password", body);
